...
export const crearInforme = async (req, res) => {
    try {
        const { areaSolicitante, edificio,solicita,fecha,folio,tipoSolicitud,tipoMantenimiento,justificacion,observaciones,proyecto,cantidad,descripcion, } = req.body;
