...
export const obtenerProyectoYActividades = async (req, res) => {
    export const obtenerProyectoConActividades = async (req, res) => {
        try {
          const { idProyecto } = req.params;
      
          // Encontrar el proyecto por ID y llenar las actividades
          const proyecto = await Proyecto.findById(idProyecto).populate('actividades');
