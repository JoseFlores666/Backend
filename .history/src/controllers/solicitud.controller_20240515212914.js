...
// Crear el objeto de suministro
const nuevoSuministro = {
    cantidad: parseInt(cantidad), // Asegúrate de convertir la cantidad a un número si es necesario
    unidadMedida: unidad,
    descripcion,
    cantidadEntregada: 0
};

// Crear la nueva solicitud con el suministro incluido
const nuevaSolicitud = new Solicitud({
    ...
    procesoClave: pc,
    suministros: [nuevoSuministro], // Aquí agregamos el nuevo suministro al arreglo de suministros
    proyecto,
    actividades: actividad, 
    justificacionAdquisicion: justificacion,
    firmas: { solicitud: '', revision: '', validacion: '', autorizacion: '' }, 
    estado: 'Recibida'
});
