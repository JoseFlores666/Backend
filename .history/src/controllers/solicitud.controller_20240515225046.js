...
areaSolicitante: "", // Puedes establecer el área solicitante si está disponible en tu aplicación
        fecha,
...
suministros: items, // Asumiendo que `items` coincide con el formato esperado en el modelo
        proyecto,
