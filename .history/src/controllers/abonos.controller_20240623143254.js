...
export const abonarSolicitud = async (req, res) => {
  try {
    ...
    solicitudExistente.folioExterno = items.cantidadAcumulada;
    solicitudExistente.suministros.cantidadAcumulada = items.cantidadAcumulada;
    solicitudExistente.suministros.cantidadEntregada = items.cantidadEntregada;
