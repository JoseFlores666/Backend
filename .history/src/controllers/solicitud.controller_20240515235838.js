...
export const crearUnaSolicitud = async (req, res) => {
  try {
    ...
    // Convierte la fecha de texto a objeto Date
    const fechaDate = new Date(fecha);

    // Crea una nueva instancia de Solicitud con los datos recibidos
    const nuevaSolicitud = new Solicitud({
        folio,
        tipoSuministro: suministro, // Cambia suministro a tipoSuministro
        pc: pc, // Cambia pc a procesoClave
        proyecto,
        actividades: actividad, // Cambia actividad a actividades
        estado,
        fecha: fechaDate,
        firmas,
        justificacionAdquisicion: justificacion, // Cambia justificacion a justificacionAdquisicion
        user,
        suministros: items // Cambia items a suministros
    });
