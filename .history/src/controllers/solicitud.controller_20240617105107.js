...
export const editarUnaSolicitud = async (req, res) => {
  try {
    ...
    // Actualiza los campos de la solicitud existente con los nuevos datos
    solicitudExistente.folioExterno = folioExterno;
    solicitudExistente.tipoSuministro = suministro;
    ...
    solicitudExistente.user = id; // Esto depende de la lógica de tu aplicación

    // Guarda los cambios en la solicitud existente
    await solicitudExistente.save();

    // Envía la respuesta con la solicitud actualizada
