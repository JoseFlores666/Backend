...
export const LlenadoDEPInforme = async (req, res) => {
  try {
    ...
    myinforme.solicitud.insumosSolicitados.fechaAtencion = Observacionestecnicas;
    myinforme.solicitud.insumosSolicitados.cantidad = pc;
    myinforme.solicitud.insumosSolicitados.descripcion = obs;
