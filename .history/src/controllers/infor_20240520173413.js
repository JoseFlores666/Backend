        ...
        const nuevoInforme = new InformeTecnico({
            ...
            informe: {
                Solicita: {
                    ...
                    areaSolicitante: solicita?.areaSolicitante,
                    edificio: solicita?.edificio,
                },
            ...
            solicitud: {
                insumosSolicitados: {
                    fechaAtencion: solicitud?.insumosSolicitados?.fechaAtencion,
                    cantidad: solicitud?.insumosSolicitados?.cantidad,
                    descripcion: solicitud?.insumosSolicitados?.descripcion,
                    Observacionestecnicas: solicitud?.insumosSolicitados?.Observacionestecnicas,
                }
            },
            firmas: {
                solicitud: firmas?.sol,
                revision: firmas?.revision,
                validacion: firmas?.validacion,
                autorizacion: firmas?.autorizacion,
            },
            user,
            estado
        });
