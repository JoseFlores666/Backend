...
$API_KEY = 'hiasd12e@gmail.com_DBWnPr3F31V613842IKk6A88vy8twis6S5033Zu0aw0VrnzC8F32s4ANfzZ6dIha'; // Reemplazar con tu clave de API de PDF.co
...
$response = convertDocxToPdf($API_KEY, $presignedData['url']);

// Verificar si hubo un error en la conversión
$result = json_decode($response, true);
if ($result === null || !isset($result['url'])) {
    die("Error converting DOCX to PDF: URL not found in API response.");
}

// Mostrar el resultado de la conversión
echo "PDF file URL: " . $result['url'];
