...
$folio = $escapedArgs[1];
$fecha = $escapedArgs[2];
$fechaAtencion = $escapedArgs[3];
$solicita = $escapedArgs[4];
$areasoli = $escapedArgs[5];
$edificio = $escapedArgs[6];
$tipoMantenimiento = $escapedArgs[7];
$tipoTrabajo = $escapedArgs[8];
$tipoSolicitud = $escapedArgs[9];
$desc = $escapedArgs[10];
$obs = $escapedArgs[11];
$itemsJson = $escapedArgs[12];
