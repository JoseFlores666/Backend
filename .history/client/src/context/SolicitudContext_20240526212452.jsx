...
import {
  ...
  updateSoli,
  idsProyect,
  traeUnProyectAct,trae_Proyect_Act_Nombre,
} from "../api/soli";
import {
  getInfome,
  createInfome,
...
export function SoliProvider({ children }) {
  ...
  const traeProyectosActividadesNombrep = async (id) => {
    try {
      console.log(traeProyectosActividadesNombrep,nombreProAct,traeProyectosActividadesNombrep,nombreProAct,traeProyectosActividadesNombrep,nombreProAct,)
      const res = await trae_Proyect_Act_Nombre(id);
      setNombreProAct(res.data.actividades);
    } catch (error) {
      console.error("Error fetching project activities:", error);
      setErrors(["Error fetching project activities"]);
    }
  ...
  return (
    <SoliContext.Provider
      value={{
        ...
        idsAct,traeProyectosActividadesNombrep,
        getIdsProyectYAct,
        crearmySoli,
        deleteSoli,
        getUnaSoli,
