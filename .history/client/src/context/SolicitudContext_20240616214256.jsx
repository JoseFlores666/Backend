...
export function SoliProvider({ children }) {
  ...
  const descargarArchivo = async () => {
    ...
    try {
          const res = await getDescarga(); // Llama a la función para obtener la descarga
          setDescarga(res.data); // Actualiza el estado con los datos de descarga
        } catch (error) {
  ...
  return (
    <SoliContext.Provider
      value={{
        soli,descargarArchivo,descarga,
        myFolioInterno,
        traeFolioInterno,
        unasoli,
        getFirmas,
