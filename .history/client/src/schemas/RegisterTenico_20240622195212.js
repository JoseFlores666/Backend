...
export const registerTecnicoSchema = z.object({
  ...
  tipoTrabajo: z.string().nonempty({ message: "El nombre del que tipo de trabajo es requerido" }),
  tipoSolicitud: z.string().nonempty({ message: "El nombre del que tipo de solicitud es requerido" }),
  descripcion: z.string().nonempty({ message: "El nombre del que tipo de solicitud es requerido" }),
  ...
  observaciones: z.string().nonempty({ message: "Las observaciones son requerida" }),
});
