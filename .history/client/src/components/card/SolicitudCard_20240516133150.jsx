  ...
  return (
    <Card className="p-4 mb-4 shadow-md rounded-lg bg-white">
      <header className="mb-2">
        ...
        <h3 className=" text-slate-500 text-md font-semibold mt-2">{soli.areaSolicitante}</h3>
      </header>
      ...
      <section className="mb-2">
        <h3 className="text-md font-semibold">Detalles del Proyecto: <span className="text-slate-500">{soli.areaSolicitante}</span></h3>
