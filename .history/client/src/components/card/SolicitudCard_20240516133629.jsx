  ...
  return (
    <Card className="p-4 mb-4 shadow-md rounded-lg bg-white">
      <header className="mb-2">
        ...
        <br/>
        <h3 className="text-md font-semibold">Area del Solicitante: <span className="text-slate-500">{soli.areaSolicitante}</span></h3>
      </header>
      <br/>
      <section className="mb-2 text-center">
      <h3 className="text-md font-semibold">Area del Solicitante: <span className="text-slate-400 text-sm">
          {soli.fecha &&
