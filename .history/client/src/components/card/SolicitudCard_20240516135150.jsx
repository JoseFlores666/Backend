  ...
  return (
    <Card className="p-4 mb-4 shadow-md rounded-lg bg-white">
      <header className="mb-2">
        ...
        <h3 className="text-md font-semibold mt-2 text-blue-600 text-center">{soli.areaSolicitante}</h3>
      </header>
      ...
      <section className="mb-2">
        <h3 className="text-md font-semibold">Detalles del Proyecto: <span className="text-blue-600">{soli.areaSolicitante}</span></h3>
      ...
      <footer className="flex flex-col items-center mb-4">
        <div className="flex gap-4 mb-4">
          <Button className="w-24" onClick={() => deleteSoli(soli._id)}>Delete</Button>
          <ButtonLink className="w-24" to={`/soliPager/${soli._id}`}>Edit</ButtonLink>
        </div>
