    ...
    <Card className="p-4 mb-4 shadow-md rounded-lg bg-white">
      <header className="flex justify-between items-center mb-2">
        <div className="text-center w-full">
          <h1 className="text-xl font-bold">{soli.folio}</h1><h4 className={`text-xl font-bold ${soli.estado === "Approved" ? "text-green-500" : "text-red-500"}`}>
          {soli.estado}
        </h4>
          <h2 className="text-md text-gray-500 mt-1">{soli.areaSolicitante}</h2>
        </div>
