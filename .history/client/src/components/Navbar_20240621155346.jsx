    ...
    <header className="fixed top-0 left-0 right-0 z-50">
      <nav className="bg-gray-50 dark:bg-black">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to={isAuthenticated ? "/soli" : "/"} className="flex items-center space-x-3 rtl:space-x-reverse">
            <img
                    ...
                    >
                      <ul className="">
                        ...
                        <li>
                          <Link
                            to="/tecnico/orden"
                            className={`block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white ${activeLink === "/soli/consulta" ? "text-blue-600" : ""}`}
                            onClick={() => setActiveLink("/soli/consulta")}
                          >
                  ...
                  <div className="relative inline-block text-left dropdown">
                    ...
                    >
                      ...
                      <ul className="py-2" aria-labelledby="user-menu-button">
                        <li>
                          <Link to="/" onClick={recargarPagina} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Cerrar Sesión</Link>
                        </li>
                      </ul>
                    </div>
                  </div>
