...
import "../index"; // Asegúrate de importar el archivo CSS
...
export function Navbar() {
  ...
  return (
    <nav className="bg-custom-blue my-3 lg:my-6 px-5 lg:px-10 rounded-lg flex flex-wrap py-5 items-center justify-between">
