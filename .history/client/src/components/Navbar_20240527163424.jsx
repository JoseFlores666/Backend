...
export function Navbar() {
  ...
  return (
    <nav className="bg-blue-500 my-3 lg:my-6 px-5 lg:px-10 rounded-lg flex flex-wrap py-5 items-center justify-between" style={{/* En tu archivo CSS (por ejemplo, styles.css) */
    
      backgroundcolor: rgb(63, 63, 189);
