...
<button className="bg-blue-600/100 shadow-lg shadow-neutral-500 hover:bg-blue-800 hover:shadow-neutral text-neutral px-6 py-3 rounded-md inline-block" onClick={guardarDatos}>
  Guardar cambios
</button>
