      ...
      <form ref={formRef} method="post" target="_blank" onSubmit={handleSubmit(onSubmit)}>
        <div className="bg-white p-6 rounded-md shadow-md">
          ...
          <div className="mb-6 text-black">
            ...
            ></textarea>
            {errors.descripcion && (
              <p className="text-red-500 mt-0.5">{errors.descripcion.message}</p>
            )}
          </div>
                  ...
                  {insumos.map((insumo, index) => (
                    <tr key={index}>
                      <td className="w-1/6 p-2 align-middle">
                        ...
                        />
                        {errors.insumos && errors.insumos[index] && errors.insumos[index].cantidad && (
                          <p className="text-red-500 mt-0.5">{errors.insumos[index].cantidad.message}</p>
                        )}
                      </td>
                      <td className="w-1/3 p-2 align-middle">
                        ...
                        />
                        {errors.insumos && errors.insumos[index] && errors.insumos[index].descripcion && (
                          <p className="text-red-500 mt-0.5">{errors.insumos[index].descripcion.message}</p>
                        )}
                      </td>
                      <td className="w-1/6 p-2 align-middle">
