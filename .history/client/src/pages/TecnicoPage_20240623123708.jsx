...
export const TecnicoPage = () => {
  ...
  useEffect(() => {
    ...
    const results = info.filter((solicitud) =>
      ...
      (solicitud.informe.solicitud.insumosSolicitados.imagen && solicitud.informe.solicitud.insumosSolicitados.imagentoLowerCase().includes(searchTerm.toLowerCase())) ||
