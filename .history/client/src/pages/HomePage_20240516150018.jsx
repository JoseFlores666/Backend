  ...
  return (
    <section className=" min-h-screen flex justify-center items-center">
      <div className="bg-gray-200 rounded-md shadow-lg p-8">
        ...
        <Link
          to="/login"
          className="bg-blue-500 hover:bg-blue-500 text-white px-6 py-3 rounded-md inline-block"
        ...
        <Link
          to="/register"
          className="bg-blue-500 hover:bg-gray-500 text-white px-6 py-3 rounded-md inline-block ml-4"
