...
export const RegisterSolicitudPage = () => {
  ...
  const guardarDatos = () => {
    ...
    const fetchProyecto = async () => {
      try {
        ...
        const proyectoNombre = await traiteUnProyecto(proyecto);
  ...
  function generarPDF() {
    ...
    const proyectoNombre = datos.proyecto;
    ...
    <div className="body2">
      <div className="formulariodatos" id="formRef">
        ...
        <div id="itemsContainer">
          ...
          <button   className="bg-blue-600/100 shadow-lg shadow-neutral-700 hover:bg-blue-700 text-white px-6 py-2 rounded-md inline-block"
onClick={agregarItem}>Agregar Item</button>
        </div>
        <div className="division">
