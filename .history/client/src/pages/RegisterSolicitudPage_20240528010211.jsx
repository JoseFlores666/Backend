...
export const RegisterSolicitudPage = () => {
  ...
  useEffect(() => {
    ...
    // Ejecutar la función cuando se actualicen los datos guardados
    if (datos.proyecto && datos.actividad) {
      fetchIndividualProyectAndActivity();
    }
  }, [datos.proyecto, datos.actividad, getIdsProyectYActIndividual]);
