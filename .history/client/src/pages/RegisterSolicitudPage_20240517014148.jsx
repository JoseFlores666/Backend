...
export const RegisterSolicitudPage = () => {
  ...
  <input type="number" id="Folio" className="Inputs2" name="Folio" placeholder="folio" autocomplete="off" />
...
<div className="division">
  <select id="Suministro" name="Suministro" className="select" autocomplete="off">
    <option value="">Seleccione un suministro</option>
    <option value="Normal">Normal</option>
    <option value="Urgente">Urgente</option>
  </select>
  <select id="PC" name="PC" className="select" autocomplete="off">
