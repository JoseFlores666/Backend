...
import { SoliContext } from "../context/SolicitudContext";
...
export const SolicitudPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    SoliProvider(data); // Puedes enviar los datos aquí a través de una solicitud a la API o hacer lo que necesites con ellos
  };
