      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-4 rounded-lg shadow-lg">
            <button
              className=" top-2 right-2 text-black hover:text-red-700 bg-transparent border-none text-xl leading-none outline-none focus:outline-none"
              onClick={closeModal}
            >
              &times;
            </button>
            ...
            <div className="relative">
              ...
              {modalImages.length > 1 && (
                <>
                  <button
                    className="absolute top-1/2 left-4 transform -translate-y-1/2 text-black hover:text-blue-600 focus:outline-none"
                    onClick={() =>
                  ...
                  <button
                    className="absolute top-1/2 right-4 transform -translate-y-1/2 text-black hover:text-blue-600 focus:outline-none"
                    onClick={() =>
                      setCurrentImageIndex((prevIndex) =>
