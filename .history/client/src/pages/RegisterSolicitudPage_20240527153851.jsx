...
//llena el input de actividades
  ...
  return (
    ...
    <form>
      ...
      <div className="mb-3">
        <label className="form-label">Proceso Clave (PC):</label>
        <select
          id="PC"
          className="form-select"
          value={pc}
      ...
      <div className="mb-3">
        ...
        >
          ...
          {/* Render options dynamically based on available projects */}
        </select>
      </div>
      <div className="mb-3">
        ...
        >
          ...
          {/* Render options dynamically based on available activities */}
        </select>
      </div>
      {items.map((item, index) => (
        <div key={index} className="mb-3">
          ...
          <label className="form-label">Descripción del bien solicitado:</label>
          <textarea
            className="form-control"
      ...
      <button type="button" className="btn btn-primary mb-3" onClick={agregarItem}>
        Agregar Item
      </button>
      <div className="mb-3">
        <label className="form-label">Justificación para la adquisición:</label>
        <textarea
          className="form-control"
          id="Justificacion"
          value={justificacion}
