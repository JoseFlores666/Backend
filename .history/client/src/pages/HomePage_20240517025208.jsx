  ...
  return (
    <section className=" min-h-screen flex justify-center items-center">
      <div className="bg-gray-200 rounded-md shadow-lg p-8">
        ...
        <Link
          to="/login"
          className="--tw-shadow-color: #007bff; shadow-lg shadow-blue-500/50 hover:bg-blue-800 text-white px-6 py-3 rounded-md inline-block"
