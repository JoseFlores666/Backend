...
export const RegisterSolicitudPage = () => {
 ...
 const handleProyectoChange = (idProyecto) => {
    ...
    setSelectedActividad(""); // Limpiar la actividad seleccionada
    // Lógica para cargar actividades basadas en el proyecto seleccionado
    if (idProyecto) {
      getIdsProyectYAct(idProyecto).catch((error) => {
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      if (SelectedProyecto && !activitiesLoaded) {
        try {
          await getIdsProyectYAct(SelectedProyecto); // Obtén las actividades del proyecto seleccionado por el id del documento
