  ...
  return (
    <>
      <div className="flex justify-between items-center p-4">
        <select value={selectedEstado} onChange={handleFilterChange} className="p-2 border rounded">
        ...
        <button onClick={handleFilterClick} className="p-2 bg-blue-500 text-white rounded">
          Filtrar
        </button>
      </div>
      {soli.length === 0 ? (
