  ...
  const guardarDatos = () => {
    ...
    if (!datos) {
      ...
      setTimeout(() => {
        ...
        doc.setFontSize(30);
        doc.setFontSize(30);
        doc.text("•", datos.suministro === "Normal" ? 92 : 165, datos.suministro === "Normal" ? img1Height - 5 : img1Height - 4.9);
        
        doc.text("•", datos.pc === "Educativo" ? 304 : 298, datos.pc === "Educativo" ? img1Height - 22 : img1Height - 1);
        doc.addImage(
          imgData2,
          "JPEG",
          0,
  ...
  return (
    <div className="body2">
      <div className="formulariodatos" id="formRef">
        <div className="division flex justify-between items-center">
          ...
          />
          <label className="labels">Selecciona la fecha:
          <input
            type="date"
            id="fecha"
            className="Inputs"
