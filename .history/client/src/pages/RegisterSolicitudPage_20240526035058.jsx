    ...
    itemsChunks.forEach((chunk, pageIndex) => {
      ...
      doc.autoTable({
        ...
        body: chunk.map((item, index) => [
          ...
          index === 0 ? "" : item.cantidad, // Contenido de la cuarta columna
          index === 0 ? "" : item.unidad, // Contenido de la quinta columna
          index === 0 ? "" : item.descripcion, // Contenido de la sexta columna
        ]),
