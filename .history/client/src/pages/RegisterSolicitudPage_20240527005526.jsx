...
export const RegisterSolicitudPage = () => {
    ...
    const fetchProyecto = async () => {
      try {
        ...
        const proyectoNombre =
          ids.find((p) => p._id === proyecto)?.nombre || "";
  ...
  function generarPDF() {
    ...
    const { id } = datos.proyecto; // Obtener el ID y el nombre del proyecto
    ...
    <div className="body2">
      <div className="formulariodatos" id="formRef">
        ...
        <div className="botones">
          <button
            className="bg-blue-600/100 shadow-lg shadow-neutral-500 hover:bg-blue-800 text-white px-6 py-3 rounded-md inline-block"
