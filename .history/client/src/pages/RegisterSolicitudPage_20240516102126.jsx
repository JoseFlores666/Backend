...
export const RegisterSolicitudPage = () => {
  ...
  return (
    <div className="body2">
      <form className="formulariodatos px-4 md:px-8 lg:px-16 py-4 md:py-8 lg:py-12 max-w-screen-md mx-auto" onSubmit={handleSubmit} ref={formRef}>
        <div className="division mb-4">
          <label htmlFor="Folio" className="labels">
            Folio:
          </label>
          <input type="number" id="Folio" className="Inputs2" name="Folio" />
        ...
        <table className="tabla-items w-full mb-4 overflow-x-auto">
  <thead>
    <tr>
      <th className="p-2">
  ...
  <tbody>
    {items.map((item, index) => (
      <tr key={index}>
        ...
        <button type="button" onClick={addItem} className="btn-agregarfila btn-primary mb-4">
          Agregar otra fila
        </button>
        <div className="division mb-4">
        ...
        <textarea
          className="inputs4 max-w-full mb-4"
          id="Justificacion"
          name="Justificacion"
        ></textarea>
        <div className="botones flex flex-col md:flex-row justify-center">
          <button type="submit" className="btn-primary mb-4 md:mb-0 md:mr-4">
            Guardar cambios
          </button>
