      ...
      <table className="w-full min-w-full divide-y divide-white-200 text-sm text-black rounded-lg overflow-hidden">
        <thead className="bg-black text-white">
          <tr>
            ...
            <th className="px-3 py-1 text-left font-medium uppercase tracking-wider border text-center cursor-pointer w-1/12">Imagen</th>
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg" ref={modalRef}>
            ...
            <div className="relative">
              <img
                ...
                className="max-w-full h-auto rounded-lg max-h-96" // Ejemplo de estilos CSS para limitar el tamaño de la imagen
              />
              {modalImages.length > 1 && (
                <>
                  <button
                    className="absolute top-1/2 left-4 transform -translate-y-1/2 text-black hover:text-blue-600"
                    onClick={() =>
                  ...
                  <button
                    className="absolute top-1/2 right-4 transform -translate-y-1/2 text-black hover:text-blue-600"
                    onClick={() =>
                      setCurrentImageIndex((prevIndex) =>
            ...
            <button
              className="absolute bottom-2 right-2 px-3 py-1 bg-gray-200 text-black rounded-lg hover:bg-gray-300"
              onClick={closeModal}
            >
              Cerrar
            </button>
