...
export const RegisterSolicitudPage = () => {
  ...
  const handleItemChange = (index, field, value) => {
    ...
    setItems(newItems); // Corregido: Solo actualiza los ítems existentes
  };
      ...
      <form className="formulariodatos" onSubmit={handleSubmit} ref={formRef}>
        <div className="division">
          ...
          <label className="labels" style={{ marginLeft: "0%" }}>
            Fecha:
            <DatePicker selected={selectedDate} className="Inputs" onChange={(date) => setSelectedDate(date)} />
          </label>
        </div>
        <div className="division">
          ...
          <div key={index} className="item">
            <div className="division">
              ...
              <select
                ...
                className="select"
                name={`Unidad_${index}`} // Usar el índice como nombre del campo
                required
              >
        ...
        <button type="submit" className="btn-primary" onClick={handleGeneratePDF}>
