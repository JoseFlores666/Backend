...
export const RegisterSolicitudPage = () => {
    ...
    itemsChunks.forEach((chunk, pageIndex) => {
      ...
      doc.autoTable({
        ...
        body: chunk.map((item, index) => [
          // Primera columna
          index === 0 ? { content: `Proyecto: ${getProyectoName(selectedProyecto)}`, rowSpan: 2 } : "", // Esta es la primera fila de la primera columna
          "", // Celda vacía para la segunda fila de la primera columna
          
          // Resto de las columnas
          "", // Celda para la segunda columna
          "", // Celda para la tercera columna
          item.cantidad, // Contenido de la cuarta columna
          item.unidad, // Contenido de la quinta columna
          item.descripcion, // Contenido de la sexta columna
        ]),
        
        theme: "grid",
        styles: { fontSize: 8, cellPadding: 2, halign: "center" },
        columnStyles: {
          0: { cellWidth: 90, rowSpan: 2 }, // Ancho de la primera columna y unión de dos filas
          1: { cellWidth: 50 },
          2: { cellWidth: 50 },
          3: { cellWidth: 50 },
          4: { cellWidth: 200 },
  ...
  const getProyectoName = (proyectoId) => {
    const proyecto = ids.find((proyecto) => proyecto._id === proyectoId);
