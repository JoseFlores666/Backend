...
const guardarDatosYGenerarPDF = () => {
  ...
  const items = Array.from(document.querySelectorAll('.formulariodatos .division')).map(division => ({
    cantidad: division.querySelector('.Inputs2').value,
    unidad: division.querySelector('.select').value,
    descripcion: division.querySelector('.inputs3').value,
  }));
