  ...
  return (
    <section className=" min-h-screen flex justify-center items-center">
      <div className="bg-gray-200 rounded-md shadow-lg p-8">
        ...
        <Link
          to="/login"
          className="bg-cyan-600 shadow-lg shadow-cyan-500/50 hover:bg-blue-800 text-white px-6 py-3 rounded-md inline-block"
        ...
        <Link
          to="/register"
          className="bg-gray-500 hover:bg-gray-800 text-white px-6 py-3 rounded-md inline-block ml-4"
