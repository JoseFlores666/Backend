  ...
  <form className="formulariodatos" onSubmit={handleSubmit} ref={formRef}>
    ...
    <div className="row">
      <div className="col-6">
        <label className="labels">
          Suministro:
          <select name="Suministro" id="Suministro" className="select" style={{marginLeft: '20%'}} required>
      ...
      <div className="col-6">
        <label className="labels">
          Proceso Clave:
          <select name="PC" id="PC" className="select" style={{marginRight: '20%'}} required>
