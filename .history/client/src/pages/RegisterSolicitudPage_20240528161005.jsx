    ...
    <div className="body2">
      <div className="formulariodatos" id="formRef">
        ...
        <div id="itemsContainer">
          {items.map((item, index) => (
            <div key={index} className="division">
              ...
              <button
                className="btn bg-red-500 hover:bg-red-600 text-white font-bold mt-2 py-0.5 px-0.001 rounded"
        ...
        <div className="botones">
          <button
            className="bg-blue-600 shadow-lg shadow-neutral-500 hover:bg-blue-800 hover:shadow-neutral text-white px-6 py-3 rounded-md inline-block"
