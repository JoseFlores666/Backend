  ...
  return (
    ...
    <form className='formulariodatos' onSubmit={handleSubmit} ref={formRef}>
      <div className='division'>
        ...
        <DatePicker selected={selectedDate} onChange={(date) => setSelectedDate(date)} name='Fecha' />
      </div>
      <div className='division'>
      ...
      {items.map((item, index) => (
        <div className='division' key={index}>
          ...
          <select value={item.unidad} onChange={(e) => handleItemChange(index, 'unidad', e.target.value)} name={`Unidad_${index}`}>
