...
<button className="bg-blue-600/100 shadow-lg shadow-neutral-300 hover:bg-blue-800 hover:shadow-neutral-100 text-white px-6 py-3 rounded-md inline-block" onClick={guardarDatos}>
  Guardar cambios
</button>
