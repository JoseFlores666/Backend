...
export const RegisterSolicitudPage = () => {
  ...
  const populateForm = (solicitud) => {
    ...
    try {
      ...
      // Obtener el nombre del proyecto en lugar del ID
      const proyectoSeleccionado = solicitud.proyecto;
      const nombreProyecto = ids.find((proyecto) => proyecto._id === proyectoSeleccionado)?.nombre || "";
  
      setSelectedProyecto(nombreProyecto);
