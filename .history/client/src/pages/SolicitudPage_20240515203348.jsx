...
import { useAuth } from "../context/SolicitudContext.jsx";
...
export const SolicitudPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(data); // Puedes enviar los datos aquí a través de una solicitud a la API o hacer lo que necesites con ellos
  };
