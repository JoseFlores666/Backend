...
export const RegisterSolicitudPage = () => {
 ...
 <div id="itemsContainer">
  {items.map((item, index) => (
    <div key={index} className="division">
      <div className="flex justify-between">
        <div className="labelsContainer mr-2 w-1/4">
      ...
      <div className="labelsContainer w-3/4">
      ...
      <button
        className="btn btn-danger mt-2 w-auto" // Agrega la clase w-auto
  ...
  <button
    className="bg-blue-600/100 shadow-lg shadow-neutral-700 hover:bg-blue-700 text-white px-6 py-2 rounded-md inline-block mt-2"
    onClick={agregarItem}
  >
    Agregar Item
  </button>
