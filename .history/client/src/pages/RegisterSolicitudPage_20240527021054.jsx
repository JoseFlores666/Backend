...
export const RegisterSolicitudPage = () => {
  ...
  function generarPDF() {
    ...
    const miFuncionPrincipal = async () => {
      // Obtiene los IDs del proyecto y la actividad de algún lugar
      const idProyecto = datos.proyecto;
      const idActividad = datos.actividad;
    
      try {
        // Llama a la función asincrónica y espera a que se complete
        const resultado = await getIdsProyectYActIndividual(idProyecto, idActividad);
        // Haz algo con el resultado obtenido
