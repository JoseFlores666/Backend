...
export const RegisterSolicitudPage = () => {
  ...
  console.log(data)//data es el id del fomulario a modificar 
  ...
  const {  traerUnasoli,updateSoli,crearmySoli,getIdsProyect, ids, getIdsProyectYAct, idsAct = [] } = useSoli();
  ...
  return (
    <div className="body2">
      ...
      <h2>{isEditing ? "Actualizar Solicitud" : "Registrar Solicitud"}</h2>
