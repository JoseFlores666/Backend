    ...
    const fetchProyecto = async () => {
      try {
        ...
        const datosSolicitud = {
          ...
          suministro,
          pc,
          proyecto: { id: proyecto, nombre: proyectoNombre },
          actividad,
          justificacion,
          items,
        };
...
<div className="botones">
        <button className="bg-blue-600/100 shadow-lg shadow-neutral-500 hover:bg-blue-800 text-white px-6 py-3 rounded-md inline-block" onClick={guardarDatos}>
          Guardar cambios
        </button>
        <button           className="bg-gray-500 shadow-lg shadow-neutral-500 hover:bg-gray-800 text-white px-6 py-3 rounded-md inline-block ml-4"
