...
export const RegisterSolicitudPage = () => {
  ...
  const { crearmySoli, getIdsProyect, ids, getIdsProyectYAct, _idAct } = useSoli();
  const [selectedProyecto, setSelectedProyecto] = useState("");
  const { user } = useAuth();

  //getIdsProyectYAct es la funcion que trae un proyecto con varias actividades por el id de ese proyecto
  //variable que englobara una ves ejecutada la funcion getIdsProyectYAct todo lo que traiga esa funcion
  useEffect(() => {
    getIdsProyect();
  }, [getIdsProyect]);
