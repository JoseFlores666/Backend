...
export const RegisterSolicitudPage = () => {
  ...
  useEffect(() => {
    const fetchIndividualProyectAndActivity = async () => {
      try {
        console.log(proyecto, actividad); 
    ...
    // Verificar si proyecto y actividad no están vacíos y fetchPDFFlag es verdadero
    if (proyecto && actividad && fetchPDFFlag) {
      fetchIndividualProyectAndActivity();
      setFetchPDFFlag(false); // Reiniciamos la bandera después de ejecutar la función
    }
