...
export const RegisterSolicitudPage = ({ isUpdating, solicitudToUpdate }) => {
  ...
  useEffect(() => {
    if (isUpdating && solicitudToUpdate) {
      setSelectedDate(new Date(solicitudToUpdate.fecha));
      setSelectedProyecto(solicitudToUpdate.proyecto);
      setItems(solicitudToUpdate.items);
      setPageTitle("Actualizar");
    }
  }, [isUpdating, solicitudToUpdate]);
