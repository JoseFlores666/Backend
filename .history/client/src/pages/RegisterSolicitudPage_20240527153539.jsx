...
//llena el input de actividades
  ...
  return (
    <div className="body2">
      <form className="formulariodatos" id="formRef">
        ...
        {items.map((item, index) => (
          ...
          <button
            className="btn btn-primary mt-3"            onClick={agregarItem}
          >
            Agregar Item
          </button>
        </div>
        ...
        <div className="mt-4">
          <button
           className="btn btn-success "   onClick={guardarDatos}
          >
            Guardar cambios
          </button>

          <button className="btn btn-primary ms-2" onClick={handleGeneratePDFClick}>Generar PDF</button>
