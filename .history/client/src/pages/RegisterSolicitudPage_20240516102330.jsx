...
export const RegisterSolicitudPage = () => {
  ...
  return (
    <div className="body2">
      <form
        className="formulariodatos px-4 md:px-8 lg:px-16 py-4 md:py-8 lg:py-12 max-w-screen-md mx-auto"
      ...
      >
        ...
        <button
          type="button"
          onClick={addItem}
          className="btn-agregarfila btn-primary mb-4"
        >
          Agregar otra fila
        </button>
        <div className="division mb-4">
        ...
        <div className="botones flex flex-col md:flex-row justify-center">
          <button
            type="submit"
            className="btn-primary mb-4 md:mb-0 md:mr-4"
          >
            Guardar cambios
          </button>
