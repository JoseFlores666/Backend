...
export const RegisterSolicitudPage = () => {
      ...
      if (solicitudId && !queryExecuted) {
        ...
        try {
          ...
          if (unasoli) {
            ...
            setSelectedSolicitud(unasoli); // Agregar esta línea
          } else {
  ...
  const populateForm = (solicitud) => {
    ...
    try {
      ...
      form.querySelector("#Suministro").value = solicitud.tipoSuministro || ""; // Ajustar al campo correcto
      ...
      setSelectedActividad(solicitud.actividades || ""); // Ajustar al campo correcto
      form.querySelector("#Justificacion").value = solicitud.justificacionAdquisicion || "";
  
      // Llenar el array de items
      if (Array.isArray(solicitud.suministros)) { // Ajustar al campo correcto
        setItems(
          solicitud.suministros.map((item) => ({
            cantidad: item.cantidad,
            unidad: item.unidad, // Ajustar al campo correcto
      ...
      // form.querySelector("#Justificacion").value = solicitud. || "";
    } catch (error) {
