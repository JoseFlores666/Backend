    ...
    itemsChunks.forEach((chunk, pageIndex) => {
      ...
      doc.autoTable({
        ...
        body: chunk.map((item, index) => [
          index === 0 ? { content: `Proyecto: ${getProyectoName(selectedProyecto)}`, rowSpan: 2 } : "", // Proyecto en la primera fila de la primera columna
          "", // Celda vacía para la segunda fila de la primera columna
          "", // Celda vacía para la segunda columna
          item.cantidad, // Datos en la tercera columna
          item.unidad, // Datos en la cuarta columna
          item.descripcion // Datos en la quinta columna
        ]),
