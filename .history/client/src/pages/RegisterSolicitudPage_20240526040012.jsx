    ...
    itemsChunks.forEach((chunk, pageIndex) => {
      ...
      doc.autoTable({
        ...
        body: chunk.map((item, index) => {
          if (index === 0) {
            return [
              { content: `Proyecto: ${getProyectoName(selectedProyecto)}`, rowSpan: 2 }, // Proyecto en la primera fila
              "", "", "", "" // Segunda fila vacía en la primera columna y celdas vacías en las demás columnas
            ];
          } else {
            return [
