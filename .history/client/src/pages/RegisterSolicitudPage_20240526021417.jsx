...
export const RegisterSolicitudPage = () => {
  ...
  const handleGeneratePDF = (event) => {
    ...
    const data = {
      ...
      pc: formData.get("PC"),
      proyecto: form.querySelector("#Proyecto option:checked").innerText, // Obtener el texto seleccionado del Proyecto
      actividad: form.querySelector("#Actividad option:checked").innerText, // Obtener el texto seleccionado de la Actividad
