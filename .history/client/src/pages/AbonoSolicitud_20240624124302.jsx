...
export const AbonoSolicitud = () => {
    ...
    const [folioExternoExistente, setFolioExternoExistente] = useState(false);
    ...
    const llenarFormulario = () => {
        ...
        setFolioExterno(unasoli.folioExterno || "");
        // Verificar si el folioExterno ya existe en la solicitud
        if (unasoli.folioExterno) {
            setFolioExternoExistente(true);
        }
    ...
    const guardarDatos = async () => {
        try {
            ...
            console.log(data)
            await RealizarAbono(myId, data); // Envía los datos a la base de datos
            limpiarDatos()
            Swal.fire({
                title: "Completado!",
                text: "Abono Exitoso",
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                disabled={folioExternoExistente}
                            />
                        </div>
                        <div>
                            <Label
