    ...
    itemsChunks.forEach((items, pageIndex) => {
      ...
      doc.autoTable({
        ...
        styles: {
          ...
          fillColor: [75, 0, 130], // Color de fondo morado (índigo)
          lineWidth: 0.1,
          lineColor: [0, 0, 0],
          cellHeight: "auto",
        },
        ...
        headStyles: {
          fillColor: [75, 0, 130], // Color de fondo morado (índigo) para el encabezado
          textColor: [255, 255, 255], // Color de texto blanco para el encabezado
        },
        rowPageBreak: "auto",
        rowStyles: {
          1: { fillColor: [0, 0, 255], textColor: [255, 255, 255] }, // Color de fondo azul y texto blanco para filas impares
          0: { fillColor: [255, 255, 255], textColor: [0, 0, 0] }   // Color de fondo blanco y texto negro para filas pares
        },
      });
