...
export const RegisterSolicitudPage = () => {
  ...
  const guardarDatos 1 async () => {
    ...
    try {
      if (editar === "true") {
        ...
        // Esperar 2 segundos después de enviar los datos por la URL
        await new Promise((resolve) => setTimeout(resolve, 2000));
      }

      // Descargar archivo externo después de esperar
      ...
      localStorage.setItem("datosSolicitud", JSON.stringify(datosGuardados));

      // Mostrar mensaje de éxito
      Swal.fire({
        title: "Completado!",
        text: editar === "true" ? "Actualización Exitosa" : "Registro Exitoso",
        icon: "success",
        confirmButtonText: "Entendido",
      });
    } catch (error) {
      console.error("Error al guardar los datos o descargar el archivo:", error);
      alert("Error al guardar los datos o descargar el archivo.");
    }
  };
  ...
  return (
    <div className="formulariodatos">
      <form
        method="post"
        action="http://localhost/Tutorial2_OpentbsWordPHP-master/formSoli.php"
      >
