  ...
  return (
    <div className="body2">
      <form className="formulariodatos" onSubmit={handleSubmit} ref={formRef}>
        ...
        <div className="division">
          <label htmlFor="TipoMantenimiento" className="labels">
        ...
        <div className="division">
          <label htmlFor="TipoTrabajo" className="labels">
            Tipo de Trabajo:
          </label>
        ...
        <div className="division">
          <label htmlFor="TipoSolicitud" className="labels">
            Tipo de Solicitud:
          </label>
        ...
        <div className="division">
          <label htmlFor="Justificacion" className="labels">
            Descripción (servicio requerido):
          </label>
        ...
        <div className="division">
          <label htmlFor="Observaciones" className="labels">
