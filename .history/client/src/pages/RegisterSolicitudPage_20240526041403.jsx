      ...
      doc.autoTable({
        ...
        body: chunk.flatMap((item, index) => [
          index === 0
            ...
            : null, // Usamos null en lugar de una cadena vacía para no agregar una columna adicional
          null, // Eliminamos la celda vacía en la segunda columna
          null, // Eliminamos la celda vacía en la tercera columna
