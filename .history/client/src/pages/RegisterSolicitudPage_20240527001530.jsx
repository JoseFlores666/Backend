...
export const RegisterSolicitudPage = () => {
  ...
  const {
    ...
    getIdsProyectYAct,
    idsAct = [],proyect,traiteUnProyecto,
  } = useSoli();
  ...
  const guardarDatos = () => {
    ...
    const fetchProyecto = async () => {
      try {
        await traiteUnProyecto(proyecto);
    ...
    fetchProyecto();
    const myproyetoEligido = proyect;
    const datosSolicitud = {
      folio,
      fecha,
      suministro,
      pc,
      proyecto:myproyetoEligido,
      actividad,
      justificacion,
      items
    };
    ...
    <div className="body2">
      <div className="formulariodatos" id="formRef">
        ...
        <select
          ...
          >
             <option value="">Seleccione una ac</option>
