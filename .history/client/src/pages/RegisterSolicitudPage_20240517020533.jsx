...
export const RegisterSolicitudPage = () => {
  ...
  const { crearmySoli, getIdsProyect, ids, getIdsProyectYAct, idsAct = [], errors: solicitudErrors } = useSoli();
  const { user, errors: authErrors } = useAuth();
...
const onSubmit = (formData) => {
    const data = {
      ...
      pc: formData.PC,
      proyecto: formRef.current.querySelector("#Proyecto option:checked").innerText,
      actividad: formRef.current.querySelector("#Actividad option:checked").innerText,
      ...
      firmas: {
        ...
        validacion: formData.Validacion,
