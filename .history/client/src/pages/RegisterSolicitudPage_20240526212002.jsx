...
export const RegisterSolicitudPage = () => {
  ...
  const guardarDatos = () => {
    ...
    const datosSolicitud = {
      ...
      fecha,
      suministro,
      pc,traeProyectosActividadesNombrep,nombreProAct,
      proyecto,
      actividad,
      justificacion,
      items,
  ...
  const handleProyectoChange = async (value) => {
    ...
    try {
      await traeProyectosActividadesNombrep(value); // Obtener las actividades del proyecto seleccionado por el nombre
  ...
  useEffect(() => {
    const fetchActivities = async () => {
      if (selectedProyecto && !activitiesLoaded) {
        try {
          await traeProyectosActividadesNombrep(selectedProyecto);
          setActivitiesLoaded(true);
        } catch (error) {
          console.error("Error fetching activities:", error);
        }
      ...
      <div className="formulariodatos" id="formRef">
        ...
        <div className="division">
          <div className="division">
            <div className="division">
              ...
              <select
                ...
                onChange={(e) => handleProyectoChange(e.target.value)} // Maneja el cambio de proyecto
              >
          ...
          <select
            ...
            onChange={(e) => setSelectedActividad(e.target.value)} // Maneja el cambio de actividad
          >
