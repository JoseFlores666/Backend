...
export const RegisterSolicitudPage = () => {
  ...
  const {
    ...
    unProyectAct,
    getIdsProyectYActIndividual,//funcion para buscar el nombre del proyecto y de la actividad
  } = useSoli();
  ...
  }, [fetchPDFFlag, proyecto, actividad, getIdsProyectYActIndividual]);

  //trae todos los proyectos
  useEffect(() => {
    const fetchProyectsAndActivities = async () => {
      try {
        await getIdsProyect();
      } catch (error) {
  ...
  const handleGeneratePDFClick = (e) => {
      ...
      <div className="formulariodatos" id="formRef">
        <div className="division">
          ...
          <input
            ...
            className="Inputs"
            value={folio}
            onChange={(e) => setFolio(e.target.value)}required
          />
        ...
        <div className="division">
          <select
            ...
            value={suministro}
            className="Inputs"
            onChange={(e) => setSuministro(e.target.value)}required
          >
          ...
          <select
            ...
            value={pc}
            className="Inputs"
            onChange={(e) => setPc(e.target.value)}required
          >
        ...
        <div className="border-separate border-spacing-2 border border-slate-500 ">
          <table className="items-table border-separate border border-slate-500 ">
            <thead>
              <tr >
                <th class="border border-slate-600">Cantidad</th>
                <th class="border border-slate-600">Unidad de medida</th>
                <th class="border border-slate-600">Descripción del bien solicitado</th>
