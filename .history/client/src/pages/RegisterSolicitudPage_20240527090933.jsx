...
export const RegisterSolicitudPage = () => {
  ...
  useEffect(() => {
    if (fetchActivitiesFlag) {
      const fetchActivities = async () => {
        try {
          console.log("actualinzando actividad y proyectos")
          console.log(datos.proyecto, datos.actividad)
  ...
  }, [fetchActivitiesFlag, getIdsProyectYActIndividual, datos.proyecto, datos.actividad]);
      ...
      <div className="formulariodatos" id="formRef">
        ...
        <div className="division">
          ...
          >
            ...
            {ids.map((proyecto) => (
              <option key={proyecto._id} value={proyecto.}>
                {proyecto.nombre}
              </option>
            ))}
          </select>
