    ...
    <div className='body2'>
      <div className='formulariodatos' ref={formRef}>
        <div className='division'>
          ...
          <DatePicker selected={selectedDate} onChange={date => setSelectedDate(date)} className='className='select font-bold'' />
        ...
        <div className='division'>
          ...
          <select id="Actividad" >
            <option value="" className='font-bold' >Seleccione la Actividad</option>
        ...
        <div className='division'>
          <input type="number" id="Cantidad" className='Inputs2' />
          <select id="Unidad">
