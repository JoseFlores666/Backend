...
export const TecnicoPage = () => {
  ...
  const [modalImageSrc, setModalImconst [currentImageIndex, setCurrentImageIndex] = useState(0);
  useEffect(() => {
    getInfo();
  }, []);
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-4 rounded-lg shadow-lg">
            ...
            <img src={modalImageSrc} alt="Imagen Modal" className="max-w-full h-auto" />
          </div>
        </div>
      )}
