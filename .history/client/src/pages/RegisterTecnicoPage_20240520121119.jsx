...
export const RegisterTecnicoPage = () => {
  ...
  const {  createInfo,getIdsProyect, ids, getIdsProyectYAct, idsAct = []   } = useSoli();
    ...
    <div className="body2">
      <form className="formulariodatos" onSubmit={handleSubmit} ref={formRef}>
        <div className="division">
          ...
          <input type="number" id="Folio" name="Folio" className="Inputfolio" />
        ...
        <div className="division">
          <label htmlFor="AreaSolicitante" className="labels">Area solicitante:</label>
          <input type="text" id="AreaSolicitante" name="AreaSolicitante" className="Inputfolio" />
        ...
        <div className="division">
          ...
          <textarea className="inputs3" id="Descripcion" name="Descripcion"></textarea>
        </div>
        <div className="division">
