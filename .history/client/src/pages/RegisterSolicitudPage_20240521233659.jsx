...
export const RegisterSolicitudPage = () => {
  ...
  const {
    getunSolitud,//funcion para traer una solicitud y traerla
    updateSoli,//funcion que te permite enviar una solicitud y actualizar 
    crearmySoli,
    getIdsProyect,
    ids,
    getIdsProyectYAct,
  ...
  useEffect(() => {
    if (data) {
      setIsEditing(true);
      // Obtener la solicitud por el ID solo una vez cuando data cambie
      updateSoli(data)
        .then((solicitudData) => {
