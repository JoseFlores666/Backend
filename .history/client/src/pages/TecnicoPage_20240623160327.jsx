            ...
            >
              ...
              <td className="px-3 py-2 whitespace-normal break-words border text-center">
                {solicitud.solicitud.insumosSolicitados.imagen.length > 0 ? (
                  <img
                    src={solicitud.solicitud.insumosSolicitados.imagen}
                    alt="Imagen"
                    className="w-21 h-22 object-cover cursor-pointer"
                    onClick={() => openModal(solicitud.solicitud.insumosSolicitados.imagen)}
                  />
                ) : (
                  <span>No Image</span>
                )}
