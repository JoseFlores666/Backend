            ...
            >
              ...
              <td className="px-3 py-2 whitespace-normal break-words border text-center">
                {solicitud.solicitud.insumosSolicitados.imagen.length > 0 ? (
                  <a href={solicitud.solicitud.insumosSolicitados.imagen[0]} target="_blank" rel="noopener noreferrer">
                    <img src={solicitud.solicitud.insumosSolicitados.imagen[0]} alt="Solicitud" className="w-16 h-16 object-cover mx-auto"/>
                  </a>
                ) : (
                  'No Image'
                )}
