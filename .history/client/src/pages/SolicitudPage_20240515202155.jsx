...
export const SolicitudPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      ...
      user: "user_id", // Reemplaza "user_id" con el ID del usuario actual
      estado: "Pendiente",
    };
    console.log(data);
    // Aquí puedes enviar los datos a través de una solicitud a la API o hacer lo que necesites con ellos
  };
