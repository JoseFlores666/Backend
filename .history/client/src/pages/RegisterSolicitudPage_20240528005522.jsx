...
export const RegisterSolicitudPage = () => {
  ...
  const guardarDatos = () => {
    ...
    }, 100); // Agrega un pequeño retraso para asegurarte de que el estado se haya actualizado
    });
  };
  ...
  useEffect(() => {
    const fetchIndividualProyectAndActivity = async () => {
      try {
        console.log(proyecto, actividad); // Aquí utiliza proyecto y actividad directamente
  ...
  }, [fetchPDFFlag, proyecto, actividad, getIdsProyectYActIndividual]); // Aquí utilizamos proyecto y actividad
