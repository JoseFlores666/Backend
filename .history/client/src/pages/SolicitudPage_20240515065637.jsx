...
const SolicitudPage = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      areaSolicitante: form.querySelector("#AreaSolicitante"),
      tipoSuministro: form.querySelector("#TipoSuministro"),
      procesoClave: form.querySelector("#ProcesoClave"),
      area: form.querySelector("#Area"),
      suministros: [
        {
          cantidad: parseInt(form.querySelector("#Cantidad").value),
          unidadMedida: form.querySelector("#UnidadMedida"),
          descripcion: form.querySelector("#Descripcion"),
          cantidadEntregada: 0,
        },
      ],
      proyecto: form.querySelector("#Proyecto"),
      ...
      user: "id", // Aquí debes sustituir por el ID del usuario actual
      estado: "Pendiente",
    };
    crearmySoli(data);
  };
