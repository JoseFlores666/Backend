      ...
      <form className="formulariodatos" onSubmit={handleSubmit} ref={formRef}>
        <div className="division">
          ...
          <DatePicker
            ...
            onChange={(date) => setSelectedDate(date)  }name="Fecha" required className="Inputs2" 
          />
        </div>
        <div className="division">
          <label htmlFor="Folio" className="labels">
          ...
          <label htmlFor="" className="labels">Solicita:</label>
          <input type="text" />
          <label htmlFor="" className="labels">Edificio:</label>
          <input type="text" />
        </div>
        <div className="division">
