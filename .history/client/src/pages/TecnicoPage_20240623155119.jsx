    ...
    <div className="overflow-x-auto">
      ...
      <table className="w-full min-w-full divide-y divide-white-200 text-sm text-black rounded-lg overflow-hidden">
        <thead className="bg-black text-white">
          <tr>
            {['Folio', 'Fecha', 'Tipo de Mantenimiento', 'Tipo de Trabajo', 'Tipo de Solicitud', 'Descripción del Servicio', 'Estado', 'Imagen', 'Acciones'].map((header, index) => (
              <th
                key={index}
                className="px-3 py-1 text-left font-medium uppercase tracking-wider border text-center cursor-pointer"
