...
export const RegisterSolicitudPage = () => {
  ...
  return (
    <div className="body2">
      <form className="formulariodatos max-w-xl mx-auto" onSubmit={handleSubmit} ref={formRef}>
        ...
        <table className="tabla-items max-w-xl mx-auto">
          <tbody>
        ...
        <textarea
          className="inputs4 max-w-xl mx-auto"
          id="Justificacion"
          name="Justificacion"
        ></textarea>
